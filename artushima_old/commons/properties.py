...
_MSG_PROPERTIES_INITIALIZED = "Properties initialized."
_MSG_PROPERTY_NOT_FOUND = "Property '{}' not found."
...
def init():
    ...
    logger.log(logger.INFO, _MSG_PROPERTIES_INITIALIZED)
...
def get(property_name):
    ...
    if property_value is None:
        logger.log_warning(_MSG_PROPERTY_NOT_FOUND.format(property_name))
